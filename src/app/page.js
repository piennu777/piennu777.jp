        ...
        <main>
          <section className="hello">
            ...
            <div className="center-text">
              <h1>I am <span className="gradient-text">Rion</span></h1>
              <p>I am an eighth grader who likes <span className="gradient-text">programming</span>, <span
                className="gradient-text">basketball</span>, <span className="gradient-text">malware</span>, <span
                  className="gradient-text">video and image editing</span>, and <span className="gradient-text">3D</span>.</p>
            </div>
          </section>
          ...
          <section className="profile" id="Profile">
            ...
            <div className="content-grid">
              <div className="content-box engineer">
                <div className="content-box-image scrolling-icons">
