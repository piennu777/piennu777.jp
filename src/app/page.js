        ...
        <main>
          <section class="hello">
            ...
            <div class="center-text">
              <h1>I am <span class="gradient-text">Rion</span></h1>
              <p>I am an eighth grader who likes <span class="gradient-text">programming</span>, <span
                class="gradient-text">basketball</span>, <span class="gradient-text">malware</span>, <span
                  class="gradient-text">video and image editing</span>, and <span class="gradient-text">3D</span>.</p>
            </div>
          </section>
          ...
          <section class="profile" id="Profile">
            ...
            <div class="content-grid">
              <div class="content-box engineer">
                <div class="content-box-image scrolling-icons">
                ...
                <div class="content-box-text">
                  <h3><i class="bi bi-code-slash"></i><br />Programming</h3>
              ...
              <div class="content-box">
                ...
                <div class="content-box-text">
                  <h3><i class="bi bi-youtube"></i><br />Subscribe</h3>
              ...
              <div class="content-box team">
                ...
                <div class="content-box-text">
                  <h3><i class="bi bi-youtube"></i><br />Total views</h3>
              ...
              <div class="bottom-row">
                <div class="about-me">
                  <div class="content">
                    <h3><i class="bi bi-cup-hot"></i><br />About me!</h3>
                    <p>PIENNUやRionという名前で活動しているプログラマーです。札幌市に在住している中学2年です。<br />
                    ...
                    <div class="sns">
                      ...
                      <a href="https://x.com/piennu_777"><i class="fa-brands fa-x-twitter"></i></a>
                      <a href="https://github.com/piennu777"><i class="fa-brands fa-github"></i></a>
                      <a href="https://discord.com/users/851357394976899116"><i class="fa-brands fa-discord"></i></a>
                    </div>
                  </div>
                  <Image
                    src={myicon}
                ...
                <div class="content-box team">
                  ...
                  <div class="content-box-text">
                    <h3><i class="bi bi-people"></i><br />Engineering Team</h3>
